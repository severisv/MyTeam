                ...
                block [] [
                    div [ _class "row" ] [
                        ...
                        div [ _class "col-sm-6 col-md-6 col-lg-6 player-info" ] [
                            Client.view2
                                Client.Features.Players.Form.containerId
                                Client.Features.Players.Form.element
                                { Id = player.Id
            ...
            |> layout
                ...
                (fun o ->
                    { o with
                          ...
                          Scripts = Images.uploadScripts cloudinarySettings.Value })
                ctx)
