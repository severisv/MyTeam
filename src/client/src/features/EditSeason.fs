  ...
  let element =
    div [ Class "mt-main" ] 
      [ div [ Class "mt-container" ] 
          [ h3 [ Class "col-xs-5" ] [ Icons.team ""
                                      str "Wam-Kam 1" ]
            h3 [ Class "col-xs-6" ] [ i [ Class "fa fa-calendar" ] []
                                      str "2018" ]
                ...
                form [ Class "update-table-form"
                  ...
                  [ div [ Class "form-group clearfix col-xs-8 col-sm-4 no-padding" ] 
                    ...
                    div [ Class "form-group clearfix" ] 
                      [ label [ Class "col-xs-4 no-padding control-label"
                                HTMLAttr.Custom("for", "AutoUpdate") ] [ str 
                                                                           "Oppdater tabell autom."
                                                                         input [ Class 
                                                                                   "form-control"
                                                                                 Name "AutoUpdate"
                                                                                 Value "true"
                          ...
                          [ div [ Class "flex-2" ] 
                              [ span [ Id "AutoUpdateTableWrapper" ] 
                                  [ label [ Class "col-xs-6" ] 
                                      [ str "URL til tabell på fotball.no" ]
                                    span [ Class "col-xs-6 " ] [ input [ Class "form-control "
                                                                         ...
                                                                         HTMLAttr.Custom
                                                                           ("data-val-url", 
                                                                            "Lenken må være en gyldig url")
                                                                         Id "SourceUrl"
                                                                         Name "SourceUrl"
                                                                         
                                                                         Value 
                                                                           "https://www.fotball.no/fotballdata/turnering/tabell/?fiksId=158436"
                                                                         Type "text" ] ] ] ] ] ]
                    br []
                    ...
                    div [ Class "form-group" ] 
                      [ button [ Type "submit"
                                 Class "btn btn-primary" ] [ str "Lagre" ] ] ] ] ] ]
